...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pm_title_tv = findViewById(R.id.pm_title_tv);
        pm_plotSynopsis_tv = findViewById(R.id.pm_plotSynopsis_tv);
        pm_rekeaseDate_tv = findViewById(R.id.pm_rekeaseDate_tv);
        pm_userRate_tv = findViewById(R.id.pm_userRate_tv);
        pm_thumbnail_iv = findViewById(R.id.pm_thumbnail_iv);

        new FetchDetails().execute(getIntent().getExtras().getInt("position"));
    }

    private class FetchDetails extends AsyncTask<Integer, Void, BitmapAndStringArrayDO> {

        HttpURLConnection urlConnection;

        @Override
        protected BitmapAndStringArrayDO doInBackground(Integer... params) {
        ...
        private BitmapAndStringArrayDO getMovieDataFromJson(String movieJsonStr, Integer param) throws JSONException {
            ...
            return new BitmapAndStringArrayDO(stringData, backDropBitmap);
        }

        @Override
        protected void onPostExecute(BitmapAndStringArrayDO pm1BitmapAndStringArrayDO) {
